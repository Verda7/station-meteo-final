...
def graphs(df):
    ...
    fig_temp.add_trace(go.Scatter(
        ...
        mode="lines",
        name="Température",
        line=dict(color="#7dd3fc", width=4)
    ))
    fig_temp.add_trace(go.Scatter(
        x=graph_df["time"],
...
try:
    ...
    with tab_home:
        render_home(df,model_names); today_summary(df); today_periods(df); st.caption("V12.9 — onglets ajustés + graphique température amélioré.")
