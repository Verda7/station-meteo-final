...
def icon_for(row, storm=0):
    ...
    if rain>0.1 or c in [51,53,55,61,80]: return "<span style='display:inline-block;line-height:0.75;text-align:center;'>☁️<br><span style='font-size:0.45em;'>💧</span></span>"
