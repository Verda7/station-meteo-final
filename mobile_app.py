...
.week-row {
    display:grid;
    grid-template-columns: 42px 86px 74px 50px 50px 50px 18px;
    align-items:center;
    column-gap:4px;
    font-size:13px;
    width:100%;
...
@media (max-width: 430px) {
    .week-row {
        grid-template-columns: 41px 80px 68px 48px 46px 45px 15px;
        column-gap:3px;
    }
    .week-temp {font-size:20px;}
    .week-small {font-size:12px;}
    .week-compact {padding:9px 8px;}
}
</style>
...
<div class="week-compact" style="border-left:5px solid {color};">
  <div class="week-row">
    ...
    <div class="week-pill" style="background:{color};"></div>
  </div>
</div>
""", unsafe_allow_html=True)
